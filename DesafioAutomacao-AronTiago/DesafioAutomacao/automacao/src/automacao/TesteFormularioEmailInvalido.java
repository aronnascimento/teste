...
public class TesteFormularioEmailInvalido {
	String navegador;
	...
	public void testBrowserScript() throws InterruptedException{
		...
		Acao.Sendkey(".quantumWizTextinputPaperinputInput[aria-label^=Qual][aria-label*=e-mail]", "loremloremlorem");
		...
		if(navegador.equalsIgnoreCase("FF")){
			Acao.ValidacaoBycssselector("div[id$='2081699196'][class^=freebirdFormviewerViewItemsItemErrorMessage]", "Esse e-mail não parece válido");
		}		
			
		else if(navegador.equalsIgnoreCase("chrome")){
			Acao.ValidacaoByClassName("freebirdFormviewerViewItemsItemErrorMessage[id$='2081699196'", "Esse e-mail não parece válido");
		}
